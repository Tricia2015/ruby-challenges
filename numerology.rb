...
def get_message(birth_path_num)
	...
	when 2
		...
		and peace-lover.  The number two indicates the desire for harmony.  it
		is a gentle, considerate, and senitive vibration.  Ruled by the Moon."
	when 3
		puts "Your numerology number is #{number}.\nNumber Three is a 
		...
		by jupiter"
	when 4
		puts "Your numerologynumber is #{number}.\nThis is the worker.
	...
	when 6
		puts "numerology number is #{number}.\nThis is the peace
		lover. The number six is a loving, stable and harmonious vibration.
		Ruled by Venus."
	when 7
		puts "Your numerology number is #{number}.\This is the deep
